# GPA Aqua — Sistema de Horas Extras · v2.1

> ### ⚠️ SI YA DESPLEGASTE LA v2.0, HAZ ESTO PRIMERO
...
│   ├── e2e.mjs           ← 49 pruebas del frontend (navegador real)
│   ├── api-test.mjs      ← 57 pruebas de la API contra PostgreSQL real
│   └── shim/             ← Emula Neon sobre pg para esas pruebas
...
Grupo GPA Aqua · Auditoría de Procesos · v2.1
